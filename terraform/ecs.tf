  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        # ERC-8004 v1.0 Contract Addresses - Ethereum Sepolia (deployed 2026-01-06 at block 9989393)
        { name = "ETHEREUM_SEPOLIA_IDENTITY_ADDRESS", value = "0x8004A818BFB912233c491871b3d84c89A494BD9e" },
        { name = "ETHEREUM_SEPOLIA_REPUTATION_ADDRESS", value = "0x8004B663056A597Dffe9eCcC1965A193B7388713" },
        { name = "ETHEREUM_SEPOLIA_VALIDATION_ADDRESS", value = "0x0000000000000000000000000000000000000000" },
        { name = "ETHEREUM_SEPOLIA_START_BLOCK", value = "9989393" },

        # ERC-8004 v1.0 Contract Addresses - Base Sepolia (NOT YET DEPLOYED)
        { name = "BASE_SEPOLIA_IDENTITY_ADDRESS", value = "0x0000000000000000000000000000000000000000" },
        { name = "BASE_SEPOLIA_REPUTATION_ADDRESS", value = "0x0000000000000000000000000000000000000000" },
        { name = "BASE_SEPOLIA_VALIDATION_ADDRESS", value = "0x0000000000000000000000000000000000000000" },

        # ERC-8004 v1.0 Contract Addresses - Linea Sepolia (NOT YET DEPLOYED)
        { name = "LINEA_SEPOLIA_IDENTITY_ADDRESS", value = "0x0000000000000000000000000000000000000000" },
        { name = "LINEA_SEPOLIA_REPUTATION_ADDRESS", value = "0x0000000000000000000000000000000000000000" },
        { name = "LINEA_SEPOLIA_VALIDATION_ADDRESS", value = "0x0000000000000000000000000000000000000000" }
      ]

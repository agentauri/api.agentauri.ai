...
//! - `NONCE_CLEANUP_INTERVAL_SECS`: Interval between cleanups (default: 3600 = 1 hour)
//!
...
impl Default for BackgroundTaskConfig {
    fn default() -> Self {
        let interval_secs = env::var("NONCE_CLEANUP_INTERVAL_SECS")
            .ok()
        ...
        Self {
            nonce_cleanup_interval: Duration::from_secs(interval_secs),
        }
    }
}
